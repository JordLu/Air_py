...
# DHT
DHT_PIN = board.D21 # Pin of Sensor
        ...
        while(self.exit_flag == 0):
            try:
                ...
                # Case of No Reading
                    ...
                    no_value += 1
                    print("Error: No Reading from DHT Sensor!! Check Connection!!")
                    # Show nA on LCD
        ...
        # Catch KeyboardException
            ...
            while(self.exit_flag == 0):
                try:
                    ...
                    continue
            pass
            print("Exiting LCD Handler!!")
            self.self.lcd.lcd_clear()
